...
# Implementations for BSD system
...
def meminfo():
	pagesize = int(_get_data_sysctl('hw.pagesize'))
	
	v_free_count = int(_get_data_sysctl('vm.stats.vm.v_free_count'))
	v_page_count = int(_get_data_sysctl('vm.stats.vm.v_page_count'))
